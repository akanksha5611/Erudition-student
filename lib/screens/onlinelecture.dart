...
class OnlineLectureScreen extends StatefulWidget {
  const OnlineLectureScreen({Key key}) : super(key: key);

  @override
  _OnlineLectureScreenState createState() => _OnlineLectureScreenState();
}

class _OnlineLectureScreenState extends State<OnlineLectureScreen> {
  String sub = "India";
